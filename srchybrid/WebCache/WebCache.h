...
#define WC_TAG_VOODOO		0x69		// hello packet tag: magic number == 'WebC' for pre-1.1 (unsupported), 'ARC4' for 1.1 and later
...
//#define MOD_VERSION  _T( "WebCache 2.0a Beta1" ) -Max ModString
