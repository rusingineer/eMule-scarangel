...
public:
	...
	void AddIPRange(uint32 IPfrom, uint32 IPto, UINT level, const CString& desc, bool temporary=false); //Xman dynamic IP-Filters
	...
	void	Process(); //Xman dynamic IP-Filters
