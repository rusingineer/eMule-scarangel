...
#include "MemDC.h" // ""
#include "IPFilter.h" //Xman show filtered servers (BlueSonicBoy)
...
{
	server_list = NULL;
	//SetGeneralPurposeFind(true); //Xman IP to country //remark: this doesn't work because of new drawing methodes
